        ...
        <div className="max-w-4xl mx-auto bg-slate-900 text-white rounded-3xl p-8 sm:p-12 relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10 space-y-6">
            ...
            <p className="text-slate-300 text-base sm:text-lg leading-relaxed max-w-2xl font-normal">
              La IA no toma decisiones de negocio. <strong className="text-white">El valor está en el criterio y la validación:</strong> saber qué pedirle, integrarlo seguro y probar cada detalle.
            </p>

            {/* Visual formula: IA + Criterio + Testing = Resultado */}
            <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 py-6">
              <div className="flex flex-col items-center gap-2 w-24">
                <div className="w-14 h-14 rounded-2xl bg-blue-900/70 border border-blue-700 flex items-center justify-center">
                  <Zap className="w-6 h-6 text-blue-400" />
                </div>
                <span className="text-[11px] font-bold text-blue-300 text-center">Velocidad</span>
              </div>
              <span className="text-2xl font-black text-slate-600">+</span>
              <div className="flex flex-col items-center gap-2 w-24">
                <div className="w-14 h-14 rounded-2xl bg-amber-900/40 border border-amber-700/60 flex items-center justify-center">
                  <Brain className="w-6 h-6 text-amber-400" />
                </div>
                <span className="text-[11px] font-bold text-amber-300 text-center">Criterio</span>
              </div>
              <span className="text-2xl font-black text-slate-600">+</span>
              <div className="flex flex-col items-center gap-2 w-24">
                <div className="w-14 h-14 rounded-2xl bg-emerald-900/40 border border-emerald-700/60 flex items-center justify-center">
                  <CheckCircle2 className="w-6 h-6 text-emerald-400" />
                </div>
                <span className="text-[11px] font-bold text-emerald-300 text-center">Testing</span>
              </div>
              <span className="text-2xl font-black text-slate-600">=</span>
              <div className="flex flex-col items-center gap-2 w-28">
                ...
                <span className="text-[11px] font-bold text-white text-center">Sin sorpresas</span>
              </div>
            </div>
