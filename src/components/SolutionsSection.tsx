    ...
    <section id="soluciones" className="py-20 bg-slate-50 border-b border-slate-200/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto text-center space-y-4 mb-16">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-blue-100 text-blue-900 text-xs font-bold tracking-wider uppercase border border-blue-200">
            ...
            >
              <div className="space-y-4">
                <div className="flex items-start justify-between gap-2">
                  <div className="p-3 rounded-xl bg-slate-50 border border-slate-100 group-hover:scale-105 transition-transform shrink-0">
                    {getIcon(sol.id)}
                  </div>
              ...
              <div className="mt-8 pt-4">
                <button
                  ...
                  className="w-full inline-flex items-center justify-center gap-2 py-3.5 px-4 rounded-xl bg-slate-900 hover:bg-blue-600 text-white text-sm font-bold shadow-sm transition-all group-hover:bg-blue-600 cursor-pointer"
                >
